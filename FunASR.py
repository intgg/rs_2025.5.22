...
class FastLoadASR:
    def __init__(self, use_vad=True, use_punc=True, disable_update=True, text_output_callback=None, max_segment_duration_seconds=3.0, input_device_index=None):
        """
        初始化快速加载版语音识别系统
